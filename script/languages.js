const LANGUAGES = () => {
  const languages = {
    ...
    vn: {
      ...
      introduction: {
        ...
        bio: "Là một lập trình viên Frontend với niềm đam mê sáng tác. ❤",
      },
      hireBtn: "Liên hệ",
      activities: {
        title: "Hoạt động",
        activity: [
          ...
          },
          {
            id: 3,
            subtitle: "KAO entertainment",
            desc: 'Tôi từng đảm nhiệm vai trò Giám đốc âm nhạc tại KAO Entertainment. KAO Entertainment là một công ty giải trí - một "start-up" từ sớm của bạn tôi. Anh ấy là một người đa tài, nhiệt huyết và đam mê. Chúng tôi đã cùng nhau tổ chức một đêm nhạc nhằm gây quỹ từ thiện vào dịp Giáng sinh năm 2021.',
  ...
  // console.log(langBtn.getAttribute("lang"));
};
